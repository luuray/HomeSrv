...
return [
    ...
    */
    'bots'                         => [
        'homesrv' => [
            'username'            => env('TG_USERNAME_homesrv', 'homesrv'),
            'token'               => env('TG_TOKKEN_homesrv', 'YOUR-BOT-TOKEN'),
            'certificate_path'    => env('TG_CERTIFICATE_homesrv', 'YOUR-CERTIFICATE-PATH'),
            'webhook_url'         => env('TG_WEBHOOK_homesrv', 'YOUR-BOT-WEBHOOK-URL'),
            'commands'            => [
